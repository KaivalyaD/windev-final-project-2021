...
// CLSID of the inner component for CBasicTwo: {AF8CEF58-23ED-4651-8600-17FC413D4920}
const CLSID CLSID_BasicTwoInner = { 0xaf8cef58, 0x23ed, 0x4651, 0x86, 0x0, 0x17, 0xfc, 0x41, 0x3d, 0x49, 0x20 };

// CLSID of the outer component for CBasicTwo: {652C69BA-F0E0-49D6-881B-EBC7A15FE774}
const CLSID CLSID_BasicTwoOuter = { 0x652c69ba, 0xf0e0, 0x49d6, 0x88, 0x1b, 0xeb, 0xc7, 0xa1, 0x5f, 0xe7, 0x74 };

// CLSID of the inner component for CPowerOne: {4C860900-6812-4631-85F0-5485449AEDB4}
const CLSID CLSID_PowerOneInner = { 0x4c860900, 0x6812, 0x4631, 0x85, 0xf0, 0x54, 0x85, 0x44, 0x9a, 0xed, 0xb4 };

// CLSID of the outer component for CPowerOne: {BFD69753-8141-4001-B065-B1366CE17E03}
const CLSID CLSID_PowerOneOuter = { 0xbfd69753, 0x8141, 0x4001, 0xb0, 0x65, 0xb1, 0x36, 0x6c, 0xe1, 0x7e, 0x3 };
